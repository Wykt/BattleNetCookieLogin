...
// in battle.net.dll
// Hard-coded because these values will probably never change, otherwise everyone would get disconnected even if they had auto login enabled
BYTE entropyEncryptionBytes[] = { 0xc8, 0x76, 0xf4, 0xae, 0x4c, 0x95, 0x2e, 0xfe, 0xf2, 0xfa, 0xf, 0x54, 0x19, 0xc0, 0x9c, 0x43 };
...
int main() {
    ...
    // encryption
    DATA_BLOB entropy;
    entropy.pbData = entropyEncryptionBytes;
    entropy.cbData = 16;
